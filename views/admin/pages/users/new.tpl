            ...
            <div class="ibox-content">
                ...
                <form method="post" action="/admin/users/create" class="form-horizontal">
                    ...
                    <div class="form-group"><label class="col-sm-2 control-label">Name Surname</label>
                        <div class="col-sm-10"><input type="text" name="name_surname" id="name_surname" class="form-control"></div>
                    </div>
                    <div class="hr-line-dashed"></div>
                    <div class="form-group"><label class="col-sm-2 control-label">Username</label>
                        <div class="col-sm-10"><input type="text" name="user_name" id="user_name" class="form-control"></div>
                    </div>
                    <div class="hr-line-dashed"></div>
                    ...
                    <div class="form-group"><label class="col-sm-2 control-label">Info</label>
                        <div class="col-sm-10"><textarea name="info" id="info" class="form-control"></textarea></div>
                    </div>
                    <div class="hr-line-dashed"></div>
